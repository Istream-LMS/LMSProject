...
public class ClientApiConstants {
    ...
    public static final String mailIdParamName="mailId";
    public static final String addressParamName="address";
    public static final String taxIdentificationNumberParamName="TIN";
    // response parameters
    ...
    public static final Set<String> CLIENT_CREATE_REQUEST_DATA_PARAMETERS = new HashSet<String>(Arrays.asList(localeParamName,
            ...
            staffIdParamName,submittedOnDateParamName,mailIdParamName,addressParamName,taxIdentificationNumberParamName));
    ...
    public static final Set<String> CLIENT_UPDATE_REQUEST_DATA_PARAMETERS = new HashSet<String>(Arrays.asList(localeParamName,
            ...
            lastnameParamName, fullnameParamName, activeParamName, activationDateParamName, staffIdParamName,mailIdParamName,
            addressParamName,taxIdentificationNumberParamName));
