...
public class LoanProductData {
    ...
    private Collection<TaxMapData> nullIfEmptyTaxes(final Collection<TaxMapData> taxes) {
    	Collection<TaxMapData> taxesLocal = taxes;
    ...
    public Collection<TaxMapData> taxes() {
        Collection<TaxMapData> taxesLocal = new ArrayList<TaxMapData>();
        if (this.taxes != null) {
