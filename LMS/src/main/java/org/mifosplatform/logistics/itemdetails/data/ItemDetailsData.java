...
public class ItemDetailsData {
	...
	public ItemDetailsData(Collection<InventoryGrnData> inventoryGrnData,Collection<org.mifosplatform.organisation.mcodevalues.data.MCodeData> qualityDatas,Collection<org.mifosplatform.organisation.mcodevalues.data.MCodeData> statusDatas,
	...
	public ItemDetailsData(final Long id,final  Long itemMasterId,final String serialNumber,final Long grnId,final  String provisioningSerialNumber,final  String quality,
			...
			final String accountNumber, String units, Long quantity,String manufacturer) {
	...
	public ItemDetailsData(Collection<OfficeData> officeData, Collection<ItemData> itemMasterData,Collection<MCodeData> manufacturerDatas) {
	...
	public Collection<org.mifosplatform.organisation.mcodevalues.data.MCodeData> getStatusDatas() {
		return statusDatas;
	}
