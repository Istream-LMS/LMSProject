...
public class CommandWrapper {
	...
	public boolean isAssetRessource() {
		// TODO Auto-generated method stub
		 return this.entityName.equalsIgnoreCase("ASSET");
	}
    public boolean isInsuranceRessource() {
		// TODO Auto-generated method stub
		 return this.entityName.equalsIgnoreCase("INSURANCE");
	}
    ...
    public boolean isLoanTaxMapResource(){
		return this.entityName.equalsIgnoreCase("LOANTAXMAPPING");
	}

	public boolean isUpdateLoneTaxMap() {
		return this.actionName.equalsIgnoreCase("UPDATE") && this.entityName.equalsIgnoreCase("LOANTAXMAPPING");	
	}
